...
Nesse semestre teremos três aulas presenciais no campus, em função do revezamento de salas. As informações específicas sobre as datas e os temas de cada aula, podem ser acessadas no [cronograma](cronograma.html).
...
- Terá entre **uma hora e uma hora e trinta minutos de duração**, entre 19h e 20h30min, conforme [cronograma](cronograma.html);
...
- Os prazos estão definidos no [cronograma](cronograma.html) do curso.
